  ...
  const experience = [
    {
      ...
      endYear: "Present",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius a, semper congue, eui",
  ...
  return (
    <>
      ...
      <Content>
        {" "}
        <Section id="intro">
          <HeroName>SURAJ Dwivedi</HeroName>
          <SubHeading>Software Engineer who loves to unravel.<br/><ScrollDownSVG /></SubHeading>
        ...
        <Section id="skills">
          ...
          <ResponsiveBlocksContainer>
            ...
            <SkillBlock
              heading={"Side Quests"}
              body={"Dabbling with blockchain and web3"}
            />
          </ResponsiveBlocksContainer>
